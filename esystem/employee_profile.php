                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a>Employee Profile</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    user_types.user_type AS user_type_name, employees.employee_id AS employee_id,
                                    ...
                                    <div class="card card-primary card-outline">
                                        <div class="card-body box-profile">
                                            ...
                                            <h3 class="profile-username text-center"><?php echo htmlspecialchars($employee['firstname']) . " " . htmlspecialchars($employee['middlename']) . " " . htmlspecialchars($employee['lastname']) ?></h3>
                                            <p class="text-muted text-center" style="margin:0; padding:0;"><?php echo $employee['user_type_name']; ?></p>
                                            <p class="text-muted text-center" style="margin:0; padding:0;">Employee ID: <?php echo $employee['employee_id']; ?></p>
                                            <p class="text-muted text-center" style="margin:0; padding:0;">Hired Since: <?php echo date('M. Y', strtotime($employee['hired_date'])); ?></p>
                                            <?php
                                            if ($active == 1) {
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class='text-muted'><?php echo $employee['address'] . ", " . $employee['barangay'] . ", " . $employee['municity'] . ", " . $employee['province'] . ", " . $employee['zipcode']; ?></p>
                                            ...
                                            <p class="text-muted">
                                                <span class="tag tag-danger"><?php echo $employee['emerg_name'] ?></span><br>
                                                <span class="tag tag-success"><?php echo $employee['emerg_relationship'] ?></span><br>
                                                <span class="tag tag-info"><?php echo $employee['emerg_address'] ?></span><br>
                                                <span class="tag tag-warning"><?php echo $employee['emerg_contact'] ?></span>
                                            </p>
                                            ...
                                            <div class="tab-content">
                                                <div class="active tab-pane" id="basic_information">
                                                    <form action="employee_profile_edit.php" method="POST" enctype="multipart/form-data">
                                                        <input type="hidden" name="employee_id" id="employee_id" value="<?php echo $employee['employee_id'] ?>" readonly>
                                                        <input type="hidden" name="active" id="active" value="<?php echo $employee['active'] ?>" readonly>
                                                        <div class="row">
                                                            <div class="col-xl-3">
                                                                <label>Hired Date<span style="color:red;" class="astris">*</span></label>
                                                                <input type="date" class="form-control" name="hired_date" id="hired_date" value="<?php echo $employee['hired_date'] ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-xl-3">
                                                                <label for="firstname">First Name<span style="color:red;" class="astris">*</span></label>
                                                                <input type="text" class="form-control" name="firstname" id="firstname" value="<?php echo $employee['firstname'] ?>" placeholder="First Name" required>
                                                            </div>
                                                            <div class="col-xl-3">
                                                                <label for="middlename">Middle Name</label>
                                                                <input type="text" class="form-control" name="middlename" id="middlename" value="<?php echo $employee['middlename'] ?>" placeholder="Middle Name (Optional)">
                                                            </div>
                                                            <div class="col-xl-3">
                                                                <label for="lastname">Last Name<span style="color:red;" class="astris">*</span></label>
                                                                <input type="text" class="form-control" name="lastname" id="lastname" value="<?php echo $employee['lastname'] ?>" placeholder="Last Name" required>
                                                            </div>
                                                            <div class="col-xl-3">
                                                                <label for="suffix">Suffix</label>
                                                                <select class="form-control" name="suffix" id="suffix">
                                                                    <?php
                                                                    if ($employee['suffix'] == 1) {
                                                                    ...
                                                                    } else if ($employee['suffix'] == "sr") {
                                                                        echo "<option value='0' disabled>- Select -</option>";
                                                                        echo "<option value='0'>N/A</option>";
                                                                        echo "<option value='sr' selected>Sr.</option>";
                                                                        echo "<option value='jr'>Jr.</option>";
                                                                    } else if ($employee['suffix'] == "jr") {
                                                                        echo "<option value='0' disabled>- Select -</option>";
                                                                        echo "<option value='0'>N/A</option>";
                                                                        echo "<option value='sr'>Sr.</option>";
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-4">
                                                                ...
                                                                <input type="text" class="form-control" name="nickname" id="nickname" value="<?php echo $employee['nickname'] ?>" required>
                                                            </div>
                                                            <div class="col-xl-4">
                                                            ...
                                                            <div class="col-xl-4">
                                                                ...
                                                                <input type="date" class="form-control" name="date_of_birth" id="date_of_birth" value="<?php echo $employee['date_of_birth']; ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-xl-4">
                                                                <label for="birth_place">Birth Place<span style="color:red;" class="astris">*</span></label>
                                                                <input type="text" class="form-control" name="birth_place" id="birth_place" placeholder="Birth Place" value="<?php echo $employee['birth_place'] ?>" required>
                                                            </div>
                                                            <div class="col-xl-4">
                                                                <label for="religion">Religion<span style="color:red;" class="astris">*</span></label>
                                                                <input type="text" class="form-control" name="religion" id="religion" placeholder="Religion" value="<?php echo $employee['religion'] ?>" required>
                                                            </div>
                                                            <div class="col-xl-4">
                                                                <label for="nationality">Nationality<span style="color:red;" class="astris">*</span></label>
                                                                <input type="text" class="form-control" name="nationality" id="nationality" placeholder="Nationality" value="<?php echo $employee['nationality'] ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-xl-4">
                                                                ...
                                                                <select class="form-control" name="civil_status" id="civil_status" required>
                                                                    ...
                                                                    } else if ($employee['civil_status'] == "married") {
                                                                        echo "<option disabled >- Select -</option>";
                                                                        echo "<option value='single'>Single</option>";
                                                                        echo "<option value='married' selected>Married</option>";
                                                                        echo "<option value='widow'>Widow</option>";
                                                                        echo "<option value='widower'>Widower</option>";
                                                                    } else if ($employee['civil_status'] == "widow") {
                                                                        echo "<option disabled >- Select -</option>";
                                                                        echo "<option value='single'>Single</option>";
                                                                        echo "<option value='married'>Married</option>";
                                                                        echo "<option value='widow' selected>Widow</option>";
                                                                        echo "<option value='widower'>Widower</option>";
                                                                    } else if ($employee['civil_status'] == "widower") {
                                                                        echo "<option disabled >- Select -</option>";
                                                                        echo "<option value='single'>Single</option>";
                                                                        echo "<option value='married'>Married</option>";
                                                                        echo "<option value='widow'>Widow</option>";
                                                    ...
                                                    <form action="myprofile_edit.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <input type="text" class="form-control" name="sss" id="sss" value="<?php echo $employee['sss'] ?>">
                                                            </div>
                                                            <div class="col-xl-6">
                                                                <label for="pag_ibig">Pag-IBIG</label>
                                                                <input type="text" class="form-control" name="pag_ibig" id="pag_ibig" value="<?php echo $employee['pag_ibig'] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                <label for="phic">PHIC</label>
                                                                <input type="text" class="form-control" name="phic" id="phic" value="<?php echo $employee['phic'] ?>">
                                                            </div>
                                                            <div class="col-xl-6">
                                                                <label for="tin">TIN</label>
                                                                <input type="text" class="form-control" name="tin" id="tin" value="<?php echo $employee['tin'] ?>">
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row" style="float:right;">
                                                    ...
                                                    <form action="myprofile_edit.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <select class="form-control" id="region" name="region" required>
                                                                    ...
                                                                    while ($region_row = $query->fetch_assoc()) {
                                                                        if ($region_row['code'] == $employee['region']) {
                                                            ...
                                                            <div class=" col-xl-6">
                                                                ...
                                                                <select class="form-control" id="province" name="province" required>
                                                                    <option disabled selected>Select</option>
                                                                    <?php
                                                                    $sql = "SELECT * FROM _provincedb WHERE national='" . $employee['region'] . "'";
                                                                    $query = $conn->query($sql);
                                                                    while ($province_row = $query->fetch_assoc()) {
                                                                        if ($province_row['code'] == $employee['province_code']) {
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <select class="form-control" id="municity" name="municity" reqiured>
                                                                    <option disabled selected>Select</option>
                                                                    <?php
                                                                    $sql = "SELECT * FROM _municitydb WHERE province='" . $employee['province_code'] . "'";
                                                                    $query = $conn->query($sql);
                                                                    while ($municity_row = $query->fetch_assoc()) {
                                                                        if ($municity_row['code'] == $employee['municity_code']) {
                                                            ...
                                                            <div class=" col-xl-6">
                                                                ...
                                                                <select class="form-control" id="barangay" name="barangay" required>
                                                                    <option disabled selected>Select</option>
                                                                    <?php
                                                                    $sql = "SELECT * FROM _barangaydb WHERE municity='" . $employee['municity_code'] . "'";
                                                                    $query = $conn->query($sql);
                                                                    while ($barangay_row = $query->fetch_assoc()) {
                                                                        if ($barangay_row['code'] == $employee['barangay_code']) {
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <input type="text" class="form-control" id="address" name="address" placeholder="Street No./Apartment Bldg./Prk. Name" value="<?php echo $employee['address'] ?>" required>
                                                            </div>
                                                            <div class="col-xl-6">
                                                                <label for="zipcode" class="control-label">Zip Code<span style="color:red;" class="astris">*</span></label>
                                                                <input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="xxxx" value="<?php echo $employee['zipcode'] ?>" required>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row" style="float:right;">
                                                    ...
                                                    <form action="myprofile_edit.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <input type="text" class="form-control" name="telephone_number" id="telephone_number" value="<?php echo $employee['telephone_number']; ?>">
                                                            </div>
                                                            <div class="col-xl-6">
                                                                <label for="cellphone_number">Cellphone Number<span style="color:red;" class="astris">*</span></label>
                                                                <input type="text" class="form-control" name="cellphone_number" id="cellphone_number" value="<?php echo $employee['cellphone_number']; ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                <label for="primary_email">Primary Email<span style="color:red;" class="astris">*</span></label>
                                                                <input type="email" class="form-control" name="primary_email" id="primary_email" value="<?php echo $employee['primary_email']; ?>">
                                                            </div>
                                                            <div class="col-xl-6">
                                                                <label for="secondary_email">Secondary Email</label>
                                                                <input type="email" class="form-control" name="secondary_email" id="secondary_email" value="<?php echo $employee['secondary_email']; ?>">
                                                            </div>
                                                        </div>
                                                        <br>
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <input type="text" class="form-control" name="emerg_name" id="emerg_name" value="<?php echo $employee['emerg_name']; ?>" required>
                                                            </div>
                                                            <div class="col-xl-6">
                                                                <label for="emerg_contact">Contact Number<span style="color:red;" class="astris">*</span></label>
                                                                <input type="text" class="form-control" name="emerg_contact" id="emerg_contact" value="<?php echo $employee['emerg_contact']; ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                <label for="emerg_relationship">Relationship<span style="color:red;" class="astris">*</span></label>
                                                                <input type="text" class="form-control" name="emerg_relationship" id="emerg_relationship" value="<?php echo $employee['emerg_relationship']; ?>" required>
                                                            </div>
                                                            <div class="col-xl-6">
                                                                <label for="emerg_address">Address<span style="color:red;" class="astris">*</span></label>
                                                                <input type="text" class="form-control" name="emerg_address" id="emerg_address" value="<?php echo $employee['emerg_address']; ?>" required>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row" style="float:right;">
                                                ...
                                                <div class="tab-pane" id="educational_background">
                                                    ...
                                                    <table id="defaultTableAllFalse" class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql = "SELECT * FROM `employees_educational_attainment` WHERE `employee_id`='" . $employee['employee_id'] . "'";
                                                            $query = $conn->query($sql);
                                                ...
                                                <div class="tab-pane" id="photo">
                                                    <form action="employee_profile_upload_photo.php" method="POST" enctype="multipart/form-data">
                                                        <div class="form-group row">
                                                            <input type="hidden" name="employee_id" id="photo_employee_id" value=<?php echo $employee['employee_id']; ?>>
                                                            <input type="hidden" name="active" id="active" value="<?php echo $employee['active']; ?>" readonly>
...
<script>
    <?php include '_JSEmployeeProfile/js_EmployeeProfile.js'; ?>
</script>
