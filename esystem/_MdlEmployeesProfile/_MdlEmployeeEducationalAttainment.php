<div class="modal fade" id="educational_attainment_add">
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            ...
            <form action="employee_profile_educational_attainment_add.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="employee_id" id="employee_id" value="<?php echo $employee['employee_id']; ?>">
                <input type="hidden" name="active" id="active" value="<?php echo $employee['active']; ?>">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" name="sy_from" id="sy_from">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="sy_to" class="col-3 col-form-label">S.Y. To</label>
                        <div class="col-9">
                            <input type="text" class="form-control" name="sy_to" id="sy_to">
                        </div>
                    </div>
                    <div class="form-group row">
...
<div class="modal fade" id="educational_attainment_edit">
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            ...
            <form action="employee_profile_educational_attainment_edit.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-3 col-form-label">Level</label>
                        <div class="col-9">
                            <select class="form-control" name="level" id="edit_level" style="width: 100%;">
                                <option selected="selected" disabled>- Select -</option>
                                <option value="1">Primary</option>
                                <option value="2">Tertiary</option>
                                <option value="3">Vocational</option>
                    ...
                    <div class="form-group row">
                        <label for="school_name" class="col-3 col-form-label">School Name</label>
                        <div class="col-9">
                            <input type="text" class="form-control" name="school_name" id="edit_school_name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="sy_from" class="col-3 col-form-label">S.Y. From</label>
                        <div class="col-9">
                            <input type="text" class="form-control" name="sy_from" id="edit_sy_from">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="sy_to" class="col-3 col-form-label">S.Y. To</label>
                        <div class="col-9">
                            <input type="text" class="form-control" name="sy_to" id="edit_sy_to">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="attainment" class="col-3 col-form-label">Attainament</label>
...
<div class="modal fade" id="educational_attainment_delete">
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            ...
            <form action="employee_delete_educational_attainment_delete.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id" id="delete_id">
                <input type="text" name="employee_id" id="delete_employee_id">
                <input type="hidden" name="active" id="active" value="<?php echo $employee['active']; ?>">
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-3 col-form-label">Level</label>
